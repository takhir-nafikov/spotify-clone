...
public class HomeRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public class ViewHolder extends RecyclerView.ViewHolder implements ViewGroup.OnClickListener {
    ...
    public void onClick(View view) {
      iHomeSelector.onCategorySelector(getAdapterPosition());
    }
  }

  public interface IHomeSelector {
    void onCategorySelector(int position);
  }
}
